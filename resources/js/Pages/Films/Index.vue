  ...
  <Box class="p-4">
    <div class="flex justify-between mb-4">
      ...
      <a-button type="primary">
        <Link :href="route('films.create')">Add New Artist</Link>
      </a-button>
    </div>
...
<script>
import { Button, Table, Input, Modal, message } from 'ant-design-vue';
      ...
      return [
        {
          ...
          maxWidth: 400,
          sorter: true,
          sortOrder: this.sortInfo?.columnKey === 'title' && this.sortInfo.order
        },
        {
          title: 'Release Date',
          ...
          align: 'center',
          sorter: true,
          sortOrder: this.sortInfo?.columnKey === 'release' && this.sortInfo.order
        },
        {
          title: 'Duration',
          dataIndex: 'duration',
